...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      { title: "Services — Meridian & Co." },
      { name: "description", content: "An intelligent wealth ecosystem built for short, peak careers and long horizons." },
      { property: "og:title", content: "Services — Meridian & Co." },
      { property: "og:description", content: "Wealth management, retirement, lifestyle, and philanthropy." },
    ],
  }),
...
const services = [
  {
    ...
    body:
      "Wealth Management & Planning is the means of actively growing, protecting, and structuring your wealth for the long-term, from the strategy and advice of a licensed Independent Wealth Manager. Operated entirely by our regulated partner's experienced finance team — choose how much to hand off, or stay involved with.",
    items: [
      "Expert Strategy, Recommendations, and Management",
      "Access to unique, institutional-grade opportunities",
      "Negotiation power for lower banking fees",
      "Discretionary Portfolio Management",
      "Investment Advisory",
      "Asset Allocation & Holistic Planning",
      "External Asset Management",
      "Specialised Fund Access",
      "Due Diligence",
      "Asset Protection",
      "Tax Optimisation",
      "Currency Protection",
  ...
  },
  {
    ...
    body:
      "As a young, high earner, your retirement isn't a traditional 20-year plan — it's a 60-year one. Through our regulated partner's sole, regulated operations, receive retirement strategies built to sustain your lifestyle and support your dependents for years to come.",
    items: [
      "Retirement Strategy",
      "Discretionary Portfolio Management",
      "Investment Advisory",
  ...
  },
  {
    ...
    body:
      "Wealth management is ultimately a means for your lifestyle. Additional services we offer exclusively to clients include post-career planning — your next chapter shouldn't wait for the end — and concierge-style lifestyle access for the moments in between.",
  ...
  return (
    <div className="bg-paper text-ink">
      ...
      {services.map((s, i) => (
        <section
          key={s.no}
          className={`${i % 2 === 0 ? "bg-paper" : "bg-iron-soft"} py-28 md:py-36`}
        >
              ...
              <div className="md:col-span-7">
                <ul className="grid grid-cols-1 gap-px overflow-hidden border-y border-ink/10 sm:grid-cols-2">
                  {s.items.map((it, idx) => (
                    <li
                      key={it}
                      className="group flex items-center justify-between border-b border-ink/10 bg-paper/0 px-1 py-5 transition-colors hover:bg-ink hover:text-paper"
                    >
                      <span className="flex items-center gap-4">
                        <span className="font-serif-italic text-xs text-flame">
      ...
      <section className="relative overflow-hidden bg-ink py-32 text-paper md:py-44">
        ...
        <div className="relative mx-auto max-w-[1400px] px-6 md:px-10">
          ...
          <Link
            to="/"
            className="mt-12 inline-flex items-center gap-3 bg-flame px-7 py-4 text-sm font-medium uppercase tracking-eyebrow text-flame-foreground transition-transform hover:translate-y-[-2px]"
          >
